...
To communicate wirelessly you need an ESP8266 module that flashed with serial to wifi bridge firmwares, like [ESP-link](<https://github.com/jeelabs/esp-link>).  
